  ...
  return (
    <section className="min-h-[900px] py-12 ">
      <div className="container mx-auto min-h-[900px] flex justify-center items-center">
        <div className="flex flex-col lg:gap-x-[30px] gap-y-8 lg:fap-y-0 lg:flex-row items-center justify-center text-center lg:text-left">
          <div className="flex-1">
            ...
            >
              ...
              <span className="text-light lg:lead lg:md-0">{compText}</span>
            </div>
          </div>
          <div
            className="flex-1"
